...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-04-2024 a las 17:37:17
...
CREATE TABLE `ofertas` (
  ...
  `especialidad` varchar(64) NOT NULL COMMENT 'si se requiere o no conocimientos adicionales',
  `modalidad` varchar(16) NOT NULL COMMENT 'presencial o remoto',
